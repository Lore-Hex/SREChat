defmodule SREChat.Store do
  ...
  alias SREChat.{Config, Errors, Observability, RegionId, Replication, Time}
  ...
  defp log_slow_store_call(request_name, duration_ms, result) do
    cond do
      ...
      match?({:error, _error}, result) ->
        SREChat.Observability.increment("store.errors", %{"request" => request_name})
