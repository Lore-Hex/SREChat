defmodule SREChat.Store.RequestPlan do
  @moduledoc false

  alias SREChat.Config
  alias SREChat.Store.{AuthTokens, Conversations, RedisPersistence}
  ...
  def build({:ingest_replicated, ops, _origin, _ts, _stream_id}) do
    mutate(ingest_scopes(ops), SREChat.Replication.Ingest.refresh_keys(ops))
  end
