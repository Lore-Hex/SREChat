defmodule SREChat.Store.Records.User do
  @moduledoc false
...
defmodule SREChat.Store.Records.Group do
  @moduledoc false
...
defmodule SREChat.Store.Records.Member do
  @moduledoc false
...
defmodule SREChat.Store.Records.Ban do
  @moduledoc false
...
defmodule SREChat.Store.Records.Presence do
  @moduledoc false
...
defmodule SREChat.Store.Records.Message do
  @moduledoc false
...
defmodule SREChat.Store.Records.Reaction do
  @moduledoc false
...
defmodule SREChat.Store.Records do
  @moduledoc false
