defmodule SREChat.RedisClient do
  @moduledoc false
  ...
  defp redis_adapter, do: Application.get_env(:sre_chat, :redis_client, Redix)
  defp pubsub_adapter, do: Application.get_env(:sre_chat, :redis_pubsub_client, Redix.PubSub)
end
