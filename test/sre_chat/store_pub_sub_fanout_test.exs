defmodule SREChat.StorePubSubFanoutTest do
  use ExUnit.Case, async: false

  alias SREChat.PubSub
  alias SREChat.Store.{GroupState, PubSubFanout, State}
  ...
  test "group action and membership changes publish to tuple keys" do
    ...
    assert_receive {:sre_chat_system_event, %{"type" => "membership_changed"}}
  end
