defmodule SREChat.Store.AuthTokensTest do
  ...
  setup do
    ...
    Application.put_env(:sre_chat, :local_jwt_secret, "test-local-jwt-secret")
  ...
  test "local JWT lookup accepts canonical tokens and falls back to opaque non-JWT tokens" do
    ...
    Application.put_env(:sre_chat, :local_jwt_secret, "rotated-local-jwt-secret")
