defmodule SREChat.StoreMessageDataTest do
  use ExUnit.Case, async: false

  alias SREChat.Store.MessageData
  ...
  test "normalise mirrors media captions and keeps attachment URL out of message text fields" do
    previous_upload_dir = Application.get_env(:sre_chat, :upload_dir)
    ...
    after
      if previous_upload_dir,
        do: Application.put_env(:sre_chat, :upload_dir, previous_upload_dir),
        else: Application.delete_env(:sre_chat, :upload_dir)
