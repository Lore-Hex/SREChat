defmodule SREChatWeb.AuthTest do
  use ExUnit.Case, async: true

  import Plug.Conn
  import Plug.Test

  alias SREChatWeb.Auth
  alias SREChat.Store
  ...
  test "admin? returns true for valid apikey" do
    old_key = Application.get_env(:sre_chat, :api_key)
    Application.put_env(:sre_chat, :api_key, "secret")
    ...
    Application.put_env(:sre_chat, :api_key, old_key)
  end
